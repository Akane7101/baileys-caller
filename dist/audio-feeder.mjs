...
const parseStreamSource = (source) => {
...
export class AudioFeeder {
    ...
    get isStreaming() { return this.#streamInput !== null; }
    /** Chunks waiting to go out. */
    get queuedChunks() { return this.#queue.length; }
